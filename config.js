...
const baseConfig = {
    VERSION,
    ALIVE: process.env.ALIVE || "I am here boss!",
    ...
    BOT_INFO: process.env.BOT_INFO || 'MIKASA;Abhi;0;https://i.ibb.co/k61bdW79/images-21.jpg;https://chat.whatsapp.com/G2HmSdfXuXgC0fke9TlGRY',
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '¹Abhi¹ꫂ;Mikasa MD bot;https://i.ibb.co/k61bdW79/images-21.jpg' : process.env.AUDIO_DATA,
